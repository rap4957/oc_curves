...
def summary_text(c, n, AQL, RQL):
    ...
    There is a {100 * consumers_risk:.2f}% chance the customer will accept the lot if it's quality if its percent defective is greater than {100*(consumer_risk):.2f}% </p></div>
    """
    return text
