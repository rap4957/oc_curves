...
def summary_text(c, n, AQL, RQL):
    ...
    <h2>Summary</h2>
    <p style="font-size:18px">There is a  {100 * (1 - producers_risk):.2f}% chance the producer (Starlight) will reject the lot if its percentage defective is greater than {1-AQL:.2f}%.<br>   
    There is a {100 * consumers_risk:.2f}% chance the customer will accept the lot if it's quality if it;'s percent defective is greater than {1-RQL:.2f}% </p></div>
    """
    return text
